...
import com.microservices.catalog.repositories.UserRepository;
...
@Service
public class CustumUserDetailsServiceImpl implements ProductService {

    private final UserRepository productRepository;

    public CustumUserDetailsServiceImpl(UserRepository productRepository) {
